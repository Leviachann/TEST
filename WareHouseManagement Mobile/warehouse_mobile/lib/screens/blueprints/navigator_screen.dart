...
class _NavigatorScreenState extends State<NavigatorScreen>
  ...
  List<vector.Vector2> _generateRoute(Rack targetRack) {
    ...
    final start = vector.Vector2(0, 0);
  ...
  String _getDirections(Rack targetRack) {
    ...
    final horizontalDist = rackPos.x - start.x;
    final verticalDist = rackPos.y - start.y;
        ...
        builder: (context, provider, _) {
          ...
          return Stack(
            children: [
              ...
              if (_isNavigating && targetRack != null)
                Positioned(
                  top: 16,
                  left: 16,
                  right: 16,
...
class WarehouseMapPainter extends CustomPainter {
  ...
  void _drawStartPosition(
    ...
    textPainter.layout();
    textPainter.paint(canvas, Offset(offsetX - textPainter.width / 2, offsetY + 15));
  }
